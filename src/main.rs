...
fn main() -> Result<()> {
    ...
    match (day, part) {
        ...
        (6, 1) => println!("The answer to Day 6 - Part 1 is: {}", days::day06::part1(&input)),
        (6, 2) => println!("The answer to Day 6 - Part 2 is: {}", days::day06::part2(&input)),
        (7, 1) => println!("The answer to Day 7 - Part 1 is: {}", days::day07::part1(&input)),
